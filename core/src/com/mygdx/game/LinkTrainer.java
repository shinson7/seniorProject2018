...
>>>>>>> origin/AyushWork
        ...
        img = new Texture("pictures/runningFigure.jpg");
        font = new BitmapFont();

        turf = new Texture("pictures/field.jpg");
=======
        batch = new SpriteBatch();
...
=======
        if (prefaceDone == false) {
            font.draw(batch, prefaceText, 125, 100, 400, 10, true);
            font.getData().setScale(.75f);
        }

>>>>>>> origin/AyushWork
        //boolean chain to determine what gets shown
        if (currentScenario.initialExplanationPassed == false && prefaceDone) {
            //Present initial explanation
            font.draw(batch, currentScenario.ie, 125, 100, 400, 10, true);
            font.getData().setScale(.75f);
<<<<<<< HEAD
        } else if (currentScenario.initialVideoPassed == false && dn == false) {
        	//open video
=======
        if (prefaceDone == false) {
...
>>>>>>> refs/remotes/origin/master
=======
        } else if (currentScenario.initialVideoPassed == false && currentScenario.initialExplanationPassed && dn == false) {
            //open video
>>>>>>> origin/AyushWork
            try {
...
<<<<<<< HEAD
<<<<<<< HEAD
        } else if (currentScenario.finalVideoPassed == false && currentScenario.initialExplanationPassed && currentScenario.choicePassed && currentScenario.finalExplanationPassed == false && dn == false) {
=======
        } else if (currentScenario.initialExplanationPassed && currentScenario.choicePassed && currentScenario.finalExplanationPassed == false && dn == false) {
            font.draw(batch, currentScenario.fe, 125, 100, 400, 10, true);
            font.getData().setScale(.5f);
        } else if (currentScenario.finalVideoPassed == false && currentScenario.initialExplanationPassed && currentScenario.choicePassed && currentScenario.finalExplanationPassed && dn == false) {
>>>>>>> origin/AyushWork
            //open video
            try {
...
<<<<<<< HEAD
<<<<<<< HEAD
                //if you have just seen the initial explanation
                if (currentScenario.initialExplanationPassed == false) {
=======
                if (prefaceDone == false) {
                    prefaceDone = true;
                } else if (currentScenario.initialExplanationPassed == false) {
                    //if you have just seen the initial explanation
>>>>>>> origin/AyushWork
                    currentScenario.initialExplanationPassed = true;
                } else if (currentScenario.initialExplanationPassed && currentScenario.choicePassed && currentScenario.finalExplanationPassed == false) {
=======
                if (prefaceDone == false) {
                    prefaceDone = true;
