...
//        System.out.println("Working Directory = " + System.getProperty("user.dir")); //Checks the current directory you're in, for reference
    ...
    public void render() {
        ...
        if (currentScenario.initialExplanationPassed == false && prefaceDone) {
            ...
            font.getData().setScale(.5f);
            //need to check for the video while still in our final explanation
            if (currentScenario.finalVideoPassed == false && showVideo && currentScenario.initialExplanationPassed && currentScenario.choicePassed && dn == false) {
                //open video
                try {
    ...
    public boolean keyDown(int i) {
        switch (i) {
            ...
            case Keys.ENTER:
                ...
                } else if (currentScenario.initialExplanationPassed && currentScenario.initialVideoPassed && currentScenario.choicePassed && currentScenario.finalVideoPassed == false) {
                    //if its time to show the video
                    showVideo = true;
                } else if (currentScenario.initialExplanationPassed && currentScenario.choicePassed && currentScenario.finalVideoPassed) {
